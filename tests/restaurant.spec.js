...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoRetornado1 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    expect(objetoRetornado1.fetchMenu()).toMatchObject({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    // ```
    ...
    expect(objetoRetornado1.consumption).toEqual([]); // Retorno: []
    // ```
    ...
    expect(objetoRetornado1.consumption).toEqual(['coxinha']); // Retorno: ["coxinha"]
    // ```
    ...
    expect(objetoRetornado2.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]) // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    // ```
    ...
    objetoRetornado3.order('coxinha');
    expect(objetoRetornado3.consumption).toEqual(['coxinha', 'agua', 'coxinha']) // Retorno: ['coxinha', 'agua', 'coxinha']
    // ```
    ...
    objetoRetornado4.order('coxinha');
    expect(objetoRetornado4.pay()).toBeCloseTo(12.87) // Retorno: somaDosPreçosDosPedidos
    // ```
